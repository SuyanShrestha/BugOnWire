...
let currentLine = canvas1.height / 2; // bug box will be at middle line initially
...
// let bug = new Bug(ctx1, canvas1, 10, currentLine, 50);
...
function restartGame() {
  // bug = new Bug(ctx1, canvas1, 10, currentLine, 50);
